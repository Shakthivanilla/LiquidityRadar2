...
def get_ai_summary_prompt(df_string):
...
def get_natural_language_query_prompt(query_input, columns):
...
def get_optimization_plan_prompt(df_string):
...
def get_aquamind_agent_prompt(df_string):
